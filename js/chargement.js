...
function showChargement(){
    ...
    document.body.appendChild(divPrinc)
    let cart = document.querySelector(".chargement-cart .label")
    divLabel.style="animation: show 3s ease;width: 600px;"
    const timeout = setTimeout(()=>{
        cart.style="animation: showCart 3s ease;width: 250px;"
